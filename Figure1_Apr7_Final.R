...
#is not it better to skip the preprocessing and jump to data. we will have to deal with char columns na s etc.
...
dry_data <- prep_long(data_Attempt13GB, "CML_ug_per_g_food", "MG_ug_per_g_food", "CML_plus_MG_g", "Dry Matter (µg/g)")
moist_data <- prep_long(data_Attempt13GB, "CML_ug_per_g_food_moist", "MG_ug_per_g_food_moist", "CML_plus_MG_g_moist", "As Fed (µg/g)")
kcal_data <- prep_long(data_Attempt13GB, "CML_ug_per_kcal_food_moist", "MG_ug_per_kcal_food_moist", "CML_plus_MG_kcal_moist", "As Fed (µg/kcal)")
